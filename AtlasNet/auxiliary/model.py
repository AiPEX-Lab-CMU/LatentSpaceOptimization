...
#Truncated Atlasnet
class AE_AtlasNet_Truncated(nn.Module):
    def __init__(self, num_points = 2048, bottleneck_size = 1024, nb_primitives = 25):
        super(AE_AtlasNet_Truncated, self).__init__()
        self.num_points = num_points
        self.bottleneck_size = bottleneck_size
        self.nb_primitives = nb_primitives
        self.encoder = nn.Sequential(
...
class VNN(nn.Module):
    def __init__(self, bottleneck_size = 1024):
        ...
        self.bottleneck_size = bottleneck_size
        self.fully_connected = nn.Linear(self.bottleneck_size, 2)
    def forward(self,x):
